...
> **글로벌 80대 기업 5개년(2020~2024) 현금흐름(Cash Flow) & 대주주 지분 변동 시계열 대시보드**  
...
본 프로젝트는 국내, 미국, 전세계 글로벌 및 추가 유망 기업 등 **총 80개 주요 기업**의 5개년 현금흐름과 대주주 지분 변동을 시계열로 분석할 수 있는 인터랙티브 금융 대시보드입니다.

- **100% 무서버(Serverless) 정적 웹 애플리케이션**: 로컬 서버나 별도 백엔드 없이 **GitHub Pages(`github.io`)** 환경에서 완벽하게 구동됩니다.
- **차트 중심의 비주얼 분석**: ECharts 기반 5개년 현금흐름(OCF, CapEx, FCF, 재무CF), 순현금(Net Cash Cushion), 주주환원(배당/자사주), 대주주 지분 도넛 및 시계열 추이.
