...
def create_full_dataset():
    # Load metadata and financial builder
    companies = []
    ...
    domestic_data = [
        {
            "id": "samsung-electronics", "name": "Samsung Electronics", "nameKo": "삼성전자", "ticker": "005930.KS",
            "category": "Domestic", "sector": "Semiconductors & Tech", "country": "South Korea", "currency": "KRW", "unit": "조원 (Trillion KRW)", "unitMultiplier": 1e12,
            "description": "글로벌 1위 메모리 반도체, 스마트폰 및 디스플레이 선도기업",
            "financials": [
            ...
            "shareholders": {
                "current": [
                    ...
                    {"name": "소액주주 및 외국인/기관", "nameKo": "소액주주 및 기타", "type": "Public/Other", "percentage": 63.32, "description": "국내외 일반 주주"}
                ],
                "history": [
        ...
        {
            "id": "sk-hynix", "name": "SK Hynix", "nameKo": "SK하이닉스", "ticker": "000660.KS",
            "category": "Domestic", "sector": "Semiconductors", "country": "South Korea", "currency": "KRW", "unit": "조원 (Trillion KRW)", "unitMultiplier": 1e12,
            ...
            "shareholders": {
                "current": [
                    ...
                    {"name": "소액주주 및 기타 외국인", "nameKo": "기타 및 소액주주", "type": "Public/Other", "percentage": 63.80, "description": "국내외 일반 주주"}
                ],
                "history": [
    ...
    # Let's import the full data builder script
    from generate_companies_data import build_all_80_companies
    return build_all_80_companies()

if __name__ == "__main__":
    from generate_companies_data import build_all_80_companies
    all_companies = build_all_80_companies()
